...
class HomeController extends GetxController {
  ...
  // ✅ UC-like services list (dummy now)
  ...
  final services = <Map<String, dynamic>>[
    ...
    // ✅ Service 2 (Dummy)
    // ✅ Service 2 (Plumbing) - FULL DATA LIKE SERVICE 1
    {
      "id": 102,
      "label": "Plumbing",
      "slug": "plumbing",
      ...
      "packagesByItem": {
        ...
        0: [
          ...
          },
          {
            ...
            "image": "assets/images/service_ac_hero.jpg",
            "shortDetails": [
              "Advanced sealing & alignment",
              "Pressure + flow test included",
            ],
            "description":
          ...
          },
          {
            ...
            "image": "assets/images/service_ac_hero.jpg",
            "shortDetails": [
              "Urgent visit + diagnosis",
              "Quote shared before repair",
            ],
            "description":
        ...
        1: [
          ...
          },
          {
            ...
            "cardBullets": [
              "Handle stiffness fix",
              "Leak prevention",
              "Hot/cold balancing",
            ],
            "image": "assets/images/service_ac_hero.jpg",
            "shortDetails": [
              "Fix mixer stiffness/leak",
              "Hot/cold water balance test",
            ],
            "description":
        ...
        2: [
          ...
          },
          {
            ...
            "image": "assets/images/service_ac_hero.jpg",
            "shortDetails": [
              "Kitchen grease + sludge cleaning",
              "Deep flush + odour control",
            ],
            "description":
    ...
    // ✅ Service 3 (Dummy)
    // ✅ Service 3 (Electrician) - FULL DATA LIKE SERVICE 1
    {
      "id": 103,
      "label": "Electrician",
      "slug": "electrician",
      ...
      "packagesByItem": {
        ...
        0: [
          {
            ...
            "image": "assets/images/service_ac_hero.jpg",
            "shortDetails": [
              "Proper mounting & balancing",
              "No loose wiring, safety checked",
            ],
            "description":
          ...
          },
          {
            ...
            "image": "assets/images/service_ac_hero.jpg",
            "shortDetails": [
              "Kitchen/Bath exhaust fan fitting",
              "Noise + airflow check included",
            ],
            "description":
        ...
        1: [
          ...
          },
          {
            ...
            "image": "assets/images/service_ac_hero.jpg",
            "shortDetails": [
              "Trip issue diagnosis",
              "Basic reset & fix included",
            ],
            "description":
        ...
        2: [
          ...
          },
          {
            ...
            "image": "assets/images/service_ac_hero.jpg",
            "shortDetails": [
              "Basic room wiring (scope based)",
              "Final load test included",
            ],
            "description":
          ...
          },
          {
            ...
            "image": "assets/images/service_ac_hero.jpg",
            "shortDetails": [
              "Ceiling light/chandelier install",
              "Secure mounting & testing",
            ],
            "description":
  ...
  Map<String, dynamic> get selectedService =>
      services[selectedServiceIndex.value];
}
