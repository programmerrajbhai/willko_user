...
class CheckoutController extends GetxController {
  ...
  List<DateTime> get next14Days => List.generate(14, (index) => DateTime.now().add(Duration(days: index)));
  ...
  void onInit() {
    super.onInit();
    // If address passed from previous screen
  ...
  Future<void> placeOrder() async {
    HapticFeedback.heavyImpact(); // Strong Vibration for confirmation
